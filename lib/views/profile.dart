...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    final double attendanceRate = user["total_sessions"] == 0
        ? 0
        : (user["sessions_attended"] / user["total_sessions"]) * 100;
            ...
            children: [
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: _membershipColor(user["membership"]),
                        borderRadius: BorderRadius.circular(20),
                      ),
                      child: Row(
              ...
              Row(
                children: [
                  ...
                  _statCard(
                    "Attended",
                    user["sessions_attended"].toString(),
                    Icons.check_circle,
                    Colors.green,
                  ),
                  const SizedBox(width: 10),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _infoTile(Icons.person, "Full Name", user["full_name"]),
                    _divider(),
                    _infoTile(Icons.email, "Email", user["email"]),
                    _divider(),
                    _infoTile(Icons.phone, "Phone", user["phone"]),
                    _divider(),
                    _infoTile(Icons.fitness_center, "Trainer", user["trainer"]),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _divider(),
                    _infoTile(Icons.event, "End Date", user["end_date"]),
                  ],
                ),
              ),
